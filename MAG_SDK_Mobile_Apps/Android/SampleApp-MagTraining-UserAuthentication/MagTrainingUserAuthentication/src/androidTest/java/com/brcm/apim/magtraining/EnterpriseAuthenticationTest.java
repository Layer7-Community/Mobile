...
public class EnterpriseAuthenticationTest {
    ...
    @Test
    public void testEnterpriseLogIn() throws InterruptedException, UiObjectNotFoundException {
        Thread.sleep(5000);
        onView(withText("Enterprise")).perform(click());
        Log.d("TAG", "Enterprise Clicked Successfully");
        Thread.sleep(10000);
        ...
        password.setText((getResourceString(R.string.password)));
