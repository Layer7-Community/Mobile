...
public class AllCertPinningCert extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_cert_pinning_with_all_cert);
    ...
    public void verifyAllCertPinning() throws Exception {
        ...
        MASSecurityConfiguration configuration = new MASSecurityConfiguration.Builder()
                ...
                .add(mCert[1])
                .add(mCert[2])
                .pinningMode(MASSecurityPinningMode.MAS_SECURITY_PINNING_MODE_ALL_CERTIFICATES)
                .build();
    ...
    void validateRequestWithSecurityConfiguration(Uri externalUri, MASSecurityConfiguration configuration) {
        ...
        MAS.invoke(request, new MASCallback<MASResponse<JSONObject>>() {
            ...
            public void onSuccess(MASResponse<JSONObject> result) {
                ...
                success_result.setText(getResources().getString(R.string.all_cert));
                //showMessage("Request Successful : All Certificates are verified.", Toast.LENGTH_LONG);
            }
    ...
    public void showMessage(final String message, final int toastLength) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(AllCertPinningCert.this, message, toastLength).show();
            }
        });
    }
